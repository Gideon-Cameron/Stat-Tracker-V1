    ...
    <div className="mx-auto max-w-7xl px-6 py-6 text-slate-200">
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-2 max-w-xl text-sm text-slate-400 sm:text-base">
                  Your current performance across all major endurance categories.
                </p>
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-900/60 p-5">
              ...
              <div className="grid grid-cols-2 gap-x-5 gap-y-4">
                ...
                {Object.entries(result).map(([testKey]) => {
                  const value =
                    formData?.[
                      testKey as keyof EnduranceFormData
                    ];
  
                  const thresholds =
                    enduranceRankThresholds[
                      testKey as EnduranceTest
                    ];
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mt-3 text-slate-400">
          Enter your endurance performance below to calculate your ranking.
        </p>
